  ...
  async putAuthenticationHandler(req, res, next) {
    try {
      ...
      res.json({
        ...
        // Jwt verify might throw generic error, we rely on TokenManager to throw ClientError if possible
        // but TokenManager code throws InvariantError for verification failure.
        next(error);
    }
  }
